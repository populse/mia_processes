...
class Bold_mni_align(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.export_parameter("template_mask", "resolution", "template_res", is_optional=False)
        self.add_link("template_res->template.resolution")
        self.export_parameter("seg_template", "resolution", "seg_template_res", is_optional=False)
