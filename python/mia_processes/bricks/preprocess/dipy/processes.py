...
class DenoiseOld(ProcessMIA):
    ...
    * Non-local means for denoising 3D images *
    ...
    def __init__(self):
        ...
        super(DenoiseOld, self).__init__()
        ...
        in_file_snr_desc = ('A input file to calculate SNR with seg_file. If'
                            'not specified, equal to in_file (a pathlike '
    ...
    def list_outputs(self, is_plugged=None):
        ...
        super(DenoiseOld, self).list_outputs()
    ...
    def run_process_mia(self):
        ...
        super(DenoiseOld, self).run_process_mia()
