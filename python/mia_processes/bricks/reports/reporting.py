...
class ReportFuncMriqc(ProcessMIA):
    ...
    def __init__(self):
        ...
        func_desc = ('An existing, uncompressed functional image file (valid '
                     'extensions: .nii)')

        func_fig_rows_desc = ('The number of lines for the functional slice '
                              'planes plot')

        func_fig_cols_desc = ('The number of columns for the functional slice '
                              'planes plot')

        func_inf_slice_start_desc = ('The first index displayed in functional '
                                     'slice planes plot')

        func_slices_gap_desc = ('Gap between slices in functional slice planes '
                                'plot')

        norm_func_desc = ('An existing, uncompressed normalised functional '
                          'image file (valid extensions: .nii)')

        norm_func_fig_rows_desc = ('The number of lines for the normalised '
                                   'functional slice planes plot')

        norm_func_fig_cols_desc = ('The number of columns for the normalised '
                                   'functional slice planes plot')

        norm_func_inf_slice_start_desc = ('The first index displayed in '
        ...
        self.add_trait("func_fig_rows",
                       traits.Int(5,
                                  output=False,
                                  optional=True,
                                  desc=func_fig_rows_desc))

        self.add_trait("func_fig_cols",
                       traits.Int(5,
                                  output=False,
                                  optional=True,
                                  desc=func_fig_cols_desc))

        self.add_trait("func_inf_slice_start",
                       traits.Either(Undefined,
                                     traits.Int,
                                     default=Undefined,
                                     output=False,
        ...
        self.add_trait("func_slices_gap",
                       traits.Either(Undefined,
                                     traits.Int,
                                     default=Undefined,
                                     output=False,
        ...
        self.add_trait("norm_func",
                       ImageFileSPM(copyfile=False,
                                    output=False,
                                    optional=False,
                                    desc=norm_func_desc))

        self.add_trait("norm_func_fig_rows",
                       traits.Int(5,
                                  output=False,
                                  optional=True,
                                  desc=norm_func_fig_rows_desc))

        self.add_trait("norm_func_fig_cols",
                       traits.Int(5,
                                  output=False,
                                  optional=True,
                                  desc=norm_func_fig_cols_desc))

        self.add_trait("norm_func_inf_slice_start",
                       traits.Either(Undefined,
                                     traits.Int,
                                     default=Undefined,
                                     output=False,
        ...
        self.add_trait("norm_func_slices_gap",
                       traits.Either(Undefined,
                                     traits.Int,
                                     default=Undefined,
                                     output=False,
