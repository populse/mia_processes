...
class Report:
    ...
    def __init__(self, report_file, dict4runtime, **kwargs):
        ...
        if "IQMs_file" in kwargs:
            ...
            self.title = ('<font size=18><b>MRIQc'
                          'group report</b></font>')
        ...
        if "IQMs_file" in kwargs:
            ...
            infos = [today_date]
            headers = ["MRIQC GROUPS CALCULATION DATE",
                       "SOFTWARES", ]
        infos.extend(
            (
    ...
    def mriqc_group_make_report(self):
        ...
        #######################################################################
        self.report.append(
            Paragraph("<font size = 18 > <b>Subjects</b> </font>",
                      self.styles['Center']))
        self.report.append(Spacer(0 * mm, 4 * mm))
        line = ReportLine(150)
        line.hAlign = 'CENTER'
        ...
        if modality == 'anat':
            ...
            ##################################################################
            self.report.append(
                Paragraph("<font size = 18 > <b>Noise</b> </font>",
                          self.styles['Center']))
            self.report.append(Spacer(0 * mm, 4 * mm))
            line = ReportLine(150)
            line.hAlign = 'CENTER'
            ...
            boxplot_snr_image = Image(self.mriqc_group['SNR'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            boxplot_snrd_image = Image(self.mriqc_group['SNRD'],
                                       width=3 * inch,
                                       height=2.5 * inch)
            boxplot_cnr_image = Image(self.mriqc_group['CNR'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            boxplot_cjv_image = Image(self.mriqc_group['CJV'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            boxplot_qi2_image = Image(self.mriqc_group['QI'],
                                      width=3 * inch,
                                      height=2.5 * inch)

            noise_data = [[boxplot_snr_image, boxplot_snrd_image],
            ...
            # FBER, EFC
            self.report.append(
                Paragraph(("<font size = 18 > <b>Spatial "
                          "distribution</b> </font>"),
                          self.styles['Center']))
            self.report.append(Spacer(0 * mm, 4 * mm))
            line = ReportLine(150)
            ...
            self.report.append(line)
            self.report.append(Spacer(0 * mm, 4 * mm))
            boxplot_fber_image = Image(self.mriqc_group['FBER'],
                                       width=3 * inch,
                                       height=2.5 * inch)
            boxplot_efc_image = Image(self.mriqc_group['EFC'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            spatial_distribution_data = [[boxplot_fber_image,
                                          boxplot_efc_image]]
            spatial_distribution_table = Table(spatial_distribution_data,
                                               [90 * mm, 70 * mm])
            ...
            self.report.append(
                Paragraph("<font size = 18 > <b>ARTIFACTS</b> </font>",
                          self.styles['Center']))
            self.report.append(Spacer(0 * mm, 4 * mm))
            line = ReportLine(150)
            line.hAlign = 'CENTER'
            self.report.append(line)
            self.report.append(Spacer(0 * mm, 4 * mm))
            boxplot_w2max_image = Image(self.mriqc_group['WM2MAX'],
                                        width=3 * inch,
                                        height=2.5 * inch)
            boxplot_inu_image = Image(self.mriqc_group['INU'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            ...
            ##################################################################
            self.report.append(
                Paragraph("<font size = 18 > <b>Tissues quality</b> </font>",
                          self.styles['Center']))
            self.report.append(Spacer(0 * mm, 4 * mm))
            line = ReportLine(150)
            line.hAlign = 'CENTER'
            ...
            boxplot_fwhm_image = Image(self.mriqc_group['FWHM'],
                                       width=3 * inch,
                                       height=2.5 * inch)
            boxplot_icvs_image = Image(self.mriqc_group['ICVS'],
                                       width=3 * inch,
                                       height=2.5 * inch)
            boxplot_rpve_image = Image(self.mriqc_group['RPVE'],
                                       width=3 * inch,
                                       height=2.5 * inch)
            boxplot_tmp_image = Image(self.mriqc_group['TMP_OVERLAP'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            boxplot_wm_image = Image(self.mriqc_group['SUMMARY_WM'],
                                     width=3 * inch,
                                     height=2.5 * inch)
            boxplot_csf_image = Image(self.mriqc_group['SUMMARY_CSF'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            boxplot_gm_image = Image(self.mriqc_group['SUMMARY_GM'],
                                     width=3 * inch,
                                     height=2.5 * inch)
            boxplot_bg_image = Image(self.mriqc_group['SUMMARY_BG'],
                                     width=3 * inch,
                                     height=2.5 * inch)

            tissues_data = [[boxplot_fwhm_image, boxplot_icvs_image],
            ...
            ##################################################################
            self.report.append(
                Paragraph("<font size = 18 > <b>Artifact</b> </font>",
                          self.styles['Center']))
            self.report.append(Spacer(0 * mm, 4 * mm))
            line = ReportLine(150)
            line.hAlign = 'CENTER'
            self.report.append(line)
            self.report.append(Spacer(0 * mm, 4 * mm))
            boxplot_aor_image = Image(self.mriqc_group['AOR'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            boxplot_aqi_image = Image(self.mriqc_group['AQI'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            boxplot_dummy_image = Image(self.mriqc_group['DUMMY'],
                                        width=3 * inch,
                                        height=2.5 * inch)
            boxplot_gsr_image = Image(self.mriqc_group['GSR'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            boxplot_fd_image = Image(self.mriqc_group['FD'],
                                     width=3 * inch,
                                     height=2.5 * inch)
            boxplot_fd_num_image = Image(self.mriqc_group['FD_NUM'],
                                         width=3 * inch, height=2.5 * inch)
            boxplot_fd_perc_image = Image(self.mriqc_group['FD_PERC'],
                                          width=3 * inch,
                                          height=2.5 * inch)
            data = [[boxplot_aor_image, boxplot_aqi_image],
            ...
            ##################################################################
            self.report.append(
                Paragraph(("<font size = 18 > <b>Temporal "
                           "information</b> </font>"),
                          self.styles['Center']))
            self.report.append(Spacer(0 * mm, 4 * mm))
            line = ReportLine(150)
            ...
            boxplot_dvars_image = Image(self.mriqc_group['DVARS'],
                                        width=3 * inch,
                                        height=2.5 * inch)
            boxplot_dvarsn_image = Image(self.mriqc_group['DVARSN'],
                                         width=3 * inch,
                                         height=2.5 * inch)
            boxplot_tsnr_num_image = Image(self.mriqc_group['TSNR'],
                                           width=3 * inch,
                                           height=2.5 * inch)
            boxplot_gcor_perc_image = Image(self.mriqc_group['GCOR'],
                                            width=3 * inch,
                                            height=2.5 * inch)

            data = [[boxplot_dvars_image, boxplot_dvarsn_image],
            ...
            # 5 page - Boxplots ##############################################
            ##################################################################
            self.report.append(Paragraph(("<font size = 18 > <b>Spatial "
                                         "information</b> </font>"),
                                         self.styles['Center']))
            self.report.append(Spacer(0 * mm, 4 * mm))
            line = ReportLine(150)
            ...
            boxplot_fwhm_image = Image(self.mriqc_group['FWHM'],
                                       width=3 * inch,
                                       height=2.5 * inch)
            boxplot_icvs_image = Image(self.mriqc_group['SNR'],
                                       width=3 * inch,
                                       height=2.5 * inch)
            boxplot_rpve_image = Image(self.mriqc_group['FBER'],
                                       width=3 * inch,
                                       height=2.5 * inch)
            boxplot_tmp_image = Image(self.mriqc_group['EFC'],
                                      width=3 * inch,
                                      height=2.5 * inch)
            boxplot_gm_image = Image(self.mriqc_group['SUMMARY_FG'],
                                     width=3 * inch,
                                     height=2.5 * inch)
            boxplot_bg_image = Image(self.mriqc_group['SUMMARY_BG'],
                                     width=3 * inch,
            ...
            data = [[boxplot_fwhm_image, boxplot_icvs_image],
                    [boxplot_rpve_image, boxplot_tmp_image],
                    [boxplot_gm_image, boxplot_bg_image]]
            table = Table(data, [90 * mm, 70 * mm])
            table.setStyle(
