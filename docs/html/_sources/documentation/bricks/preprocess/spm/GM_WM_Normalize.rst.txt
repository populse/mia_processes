...
The GM_WM_Normalize brick is equivalent to the `Normalize12 <https://populse.github.io/mia_processes/html/documentation/preprocess/spm/Normalize12.html>`_ brick from the mia_processes library, with an additional filter (*in_filter*
