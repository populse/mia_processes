...
========================
PairedTTestDesign brick
========================

Create SPM design for paired t-test (SPM12 fMRI factorial Design)
---------------------------------------------------------------------------------------------------------------
...
- *paired_files* <=> pairs* [#label]_ (a list of list with 2 items which are a string representing an existing file):
    Input paired files.

    ::

        ex. [['/home/username/data/derived_data/sub-001_data/beta_001.nii', '/home/username/data/derived_data/sub-001_data/beta_002.nii',],
        ['/home/username/data/derived_data/sub-002_data/beta_001.nii', '/home/username/data/derived_data/sub-002_data/beta_002.nii']]
