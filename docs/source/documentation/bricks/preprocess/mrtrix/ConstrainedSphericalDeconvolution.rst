...
`ResponseSDDhollander <bricks/preprocess/mrtrix/ResponseSDDhollander.html>`_ brick.
...
- *wm_txt* (a string representing an existing file)
    WM (white matter) response text file, for example from `ResponseSDDhollander <bricks/preprocess/mrtrix/ResponseSDDhollander.html>`_ brick.
...
- *csf_txt* (a string representing an existing file, optional)
    CSF (Cerebrospinal fluid) response text file, for example from `ResponseSDDhollander <bricks/preprocess/mrtrix/ResponseSDDhollander.html>`_ brick.
...
- *gm_txt* (a string representing an existing file, optional)
    GM (grey matter) response text file, for example from `ResponseSDDhollander <bricks/preprocess/mrtrix/ResponseSDDhollander.html>`_ brick.
